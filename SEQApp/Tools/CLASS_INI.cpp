...
/////////////////////////////////////////////////////////////////////////////////
#include "..\pch.h" // include if you got "fatal error C1010: unexpected end of file..."
#include "CLASS_INI.h"
#include <string.h>
#include <stdio.h>
#include <assert.h>
...
{
	// lpEnd - lpStart already counts TCHARs; the old form truncated both
	// pointers to 32 bits before subtracting, which is not valid on x64.
	const DWORD LEN = (DWORD)(lpEnd - lpStart);
	LPTSTR psz = new TCHAR[LEN + 1];
...
//	GetPrivateProfileString((LPCWSTR)szSection, (LPCWSTR)szKey, (LPCWSTR)szDefaultValue, (LPWSTR)szResult, 255, (LPCWSTR)m_szFileName);
//	return szResult;
//}
//
