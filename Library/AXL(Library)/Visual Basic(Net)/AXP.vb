...
Module AXP
    ...
    ' lMacroNo     : 0 ~ 7
    Public Declare Function AxpMacroBeginNode Lib "AXL.dll" (ByVal lMacroNo As Integer) As Integer
    ' Terminates node registration to the specified macro.
    ' lMacroNo     : 0 ~ 7
    Public Declare Function AxpMacroEndNode Lib "AXL.dll" (ByVal lMacroNo As Integer) As Integer
    ...
    Public Declare Function AxpMacroWriteClear Lib "AXL.dll" (ByVal lMacroNo As Integer) As Integer
    ...
    Public Declare Function AxpMacroAddNode Lib "AXL.dll" (ByVal lMacroNo As Integer, ByVal uFunction As Integer, ByRef dpArg As Double) As Integer
    ...
    Public Declare Function AxpMacroGetNode Lib "AXL.dll" (ByVal lMacroNo As Integer, ByVal lNodeNo As Integer, ByRef upFunction As Integer, ByRef dpArg As Double) As Integer
    ...
    Public Declare Function AxpMacroCheckNodeAll Lib "AXL.dll" (ByVal lMacroNo As Integer, ByRef lpErrorNodeNo As Integer, ByRef upErrorCode As Integer) As Integer
    ...
    Public Declare Function AxpMacroStart Lib "AXL.dll" (ByVal lMacroNo As Integer, ByVal uCondition As Integer, ByVal bLockResource As Boolean, ByVal lRepeatCount As Integer) As Integer
    ' Returns the driving condition of the specified macro.
    ' lMacroNo         : 0 ~ 7
    Public Declare Function AxpMacroGetStartInfo Lib "AXL.dll" (ByVal lMacroNo As Integer, ByRef upCondition As Integer, ByRef bpLockResource As Boolean, ByRef lpRepeatCount As Integer) As Integer
    ...
    '  [0] MACRO_QUICK_STOP
    '  [1] MACRO_SLOW_STOP
    Public Declare Function AxpMacroStop Lib "AXL.dll" (ByVal lMacroNo As Integer, ByVal uStopMode As Integer) As Integer
    ...
    Public Declare Function AxpMacroReadRunStatus Lib "AXL.dll" (ByVal lMacroNo As Integer, ByRef upStatus As Integer, ByRef lpRepeatCount As Integer) As Integer
    ...
    Public Declare Function AxpMacroGetNodeNum Lib "AXL.dll" (ByVal lMacroNo As Integer, ByRef lpCurNodeNo As Integer, ByRef lpTotalNodeNum As Integer) As Integer
    ...
    Public Declare Function AxpMacroReadFunctionStatus Lib "AXL.dll" (ByVal lMacroNo As Integer, ByVal uFunction As Integer, ByRef dpReturnData As Double) As Integer
End Module