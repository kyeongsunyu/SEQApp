...
' lMacroNo     : 0 ~ 7
Public Declare Function AxpMacroBeginNode Lib "AXL.dll" (ByVal lMacroNo As Long) As Long
' Terminates node registration to the specified macro.
' lMacroNo     : 0 ~ 7
Public Declare Function AxpMacroEndNode Lib "AXL.dll" (ByVal lMacroNo As Long) As Long
...
Public Declare Function AxpMacroWriteClear Lib "AXL.dll" (ByVal lMacroNo As Long) As Long
...
Public Declare Function AxpMacroAddNode Lib "AXL.dll" (ByVal lMacroNo As Long, ByVal uFunction As Long, ByRef dpArg As Double) As Long
...
Public Declare Function AxpMacroGetNode Lib "AXL.dll" (ByVal lMacroNo As Long, ByVal lNodeNo As Long, ByRef upFunction As Long, ByRef dpArg As Double) As Long
...
Public Declare Function AxpMacroCheckNodeAll Lib "AXL.dll" (ByVal lMacroNo As Long, ByRef lpErrorNodeNo As Long, ByRef upErrorCode As Long) As Long
...
Public Declare Function AxpMacroStart Lib "AXL.dll" (ByVal lMacroNo As Long, ByVal uCondition As Long, ByVal bLockResource As Boolean, ByVal lRepeatCount As Long) As Long
' Returns the driving condition of the specified macro.
' lMacroNo         : 0 ~ 7
Public Declare Function AxpMacroGetStartInfo Lib "AXL.dll" (ByVal lMacroNo As Long, ByRef upCondition As Long, ByRef bpLockResource As Boolean, ByRef lpRepeatCount As Long) As Long
...
'  [0] MACRO_QUICK_STOP
'  [1] MACRO_SLOW_STOP
Public Declare Function AxpMacroStop Lib "AXL.dll" (ByVal lMacroNo As Long, ByVal uStopMode As Long) As Long
...
Public Declare Function AxpMacroReadRunStatus Lib "AXL.dll" (ByVal lMacroNo As Long, ByRef upStatus As Long, ByRef lpRepeatCount As Long) As Long
...
Public Declare Function AxpMacroGetNodeNum Lib "AXL.dll" (ByVal lMacroNo As Long, ByRef lpCurNodeNo As Long, ByRef lpTotalNodeNum As Long) As Long
...
Public Declare Function AxpMacroReadFunctionStatus Lib "AXL.dll" (ByVal lMacroNo As Long, ByVal uFunction As Long, ByRef dpReturnData As Double) As Long