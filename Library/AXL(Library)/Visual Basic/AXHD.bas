...
Public Const IPxyPWMRead = &HA                              ' PGM-1 PWM Output Setting DATA READ(0~6) 3bit = &H00
Public Const IPxyPWMWrite = &H8A                            ' PGM-1 PWM Output Setting DATA WRITE
...
Public Const IPxySPDRead = &HC                              ' PGM-1 Current SPEED DATA READ 16bit = &H0000
Public Const IPxyNoOperation_8C = &H8C                      ' No operation
Public Const IPxySPDCMPRead = &HD                           ' PGM-1 Current SPEED Compare DATA READ 16bit = &H0000
Public Const IPxySPDCMPWrite = &H8D                         ' PGM-1 Current SPEED Compare DATA WRITE
...
Public Const IPxySPDCMPRead_1D = &H1D                       ' PGM-1 Current SPEED Compare DATA READ(Same with = &H0D)
Public Const IPxySPDCMPWrite_9D = &H9D                      ' PGM-1 Current SPEED Compare DATA WRITE(Same with = &H8D)
Public Const IPxyACCPULSERead = &H1E                        ' PGM-1 Acceleration PULSE COUNTER READ 32bit = &H00000000
...
Public Const IPxyPORGDRV = &HA4                             ' +ORIGIN(Home) SEARCH DRIVE
...
Public Const IPxyMORGDRV = &HA9                             ' -ORIGIN(Home) SEARCH DRIVE
...
Public Const IPxyDRIVEMODERead = &H2D                       ' Drive Operation Setting DATA READ
Public Const IPxyDRIVEMODEWrite = &HAD                      ' Drive Operation Setting DATA WRITE
...
Public Const IPxySWLMTCONRead = &H36                        ' SOFT LIMIT Setting READ 3bit = &H00
Public Const IPxySWLMTCONWrite = &HB6                       ' SOFT LIMIT Setting WRITE
Public Const IPxyMSWLMTCOMPRead = &H37                      ' -SOFT LIMIT Compare data READ 32bit = &H80000000
Public Const IPxyMSWLMTCOMPWrite = &HB7                     ' -SOFT LIMIT Compare data WRITE
Public Const IPxyPSWLMTCOMPRead = &H38                      ' +SOFT LIMIT Compare data READ 32bit = &H7FFFFFFF
Public Const IPxyPSWLMTCOMPWrite = &HB8                     ' +SOFT LIMIT Compare data WRITE
Public Const IPxyTRGCONRead = &H39                          ' TRIGGER MODE Setting READ 32bit = &H00010000
Public Const IPxyTRGCONWrite = &HB9                         ' TRIGGER MODE Setting WRITE
Public Const IPxyTRGCOMPRead = &H3A                         ' TRIGGER Compare data READ 32bit = &H00000000
Public Const IPxyTRGCOMPWrite = &HBA                        ' TRIGGER Compare data WRITE
Public Const IPxyICMRead = &H3B                             ' INTERNAL M-DATA Setting READ 32bit = &H80000000
Public Const IPxyICMWrite = &HBB                            ' INTERNAL M-DATA Setting WRITE
Public Const IPxyECMRead = &H3C                             ' EXTERNAL M-DATA Setting READ 32bit = &H80000000
Public Const IPxyECMWrite = &HBC                            ' EXTERNAL M-DATA Setting WRITE
...
Public Const IPySCRCON1Read = &H40                          ' Script operation setting-1 READ 32bit = &H00000000
Public Const IPySCRCON1Write = &HC0                         ' Script operation setting-1 WRITE
Public Const IPySCRCON2Read = &H41                          ' Script operation setting-2 READ 32bit = &H00000000
Public Const IPySCRCON2Write = &HC1                         ' Script operation setting-2 WRITE
Public Const IPySCRCON3Read = &H42                          ' Script operation setting-3 READ 32bit = &H00000000
Public Const IPySCRCON3Write = &HC2                         ' Script operation setting-3 WRITE
Public Const IPySCRCONQRead = &H43                          ' Script operation setting-Queue READ 32bit = &H00000000
Public Const IPySCRCONQWrite = &HC3                         ' Script operation setting-Queue WRITE
Public Const IPySCRDATA1Read = &H44                         ' Script operation data-1 READ 32bit = &H00000000
Public Const IPySCRDATA1Write = &HC4                        ' Script operation data-1 WRITE
Public Const IPySCRDATA2Read = &H45                         ' Script operation data-2 READ 32bit = &H00000000
Public Const IPySCRDATA2Write = &HC5                        ' Script operation data-2 WRITE
Public Const IPySCRDATA3Read = &H46                         ' Script operation data-3 READ 32bit = &H00000000
Public Const IPySCRDATA3Write = &HC6                        ' Script operation data-3 WRITE
Public Const IPySCRDATAQRead = &H47                         ' Script operation data-Queue READ 32bit = &H00000000
Public Const IPySCRDATAQWrite = &HC7                        ' Script operation data-Queue WRITE
Public Const IPyNoOperation_48 = &H48                       ' No operation
Public Const IPySCRQCLR = &HC8                              ' Script Queue clear
Public Const IPySCRCQSIZERead = &H49                        ' Script operation setting Queue Index READ 4bit = &H00
Public Const IPyNoOperation_C9 = &HC9                       ' No operation
Public Const IPySCRDQSIZERead = &H4A                        ' Script operation data Queue Index READ 4bit = &H00
Public Const IPyNoOperation_CA = &HCA                       ' No operation
Public Const IPySCRQFLAGRead = &H4B                         ' Script Queue Full/Empty Flag READ 4bit = &H05
Public Const IPyNoOperation_CB = &HCB                       ' No operation
Public Const IPySCRQSIZECONRead = &H4C                      ' Script Queue size setting(0~13) READ 16bit = &HD0D0
Public Const IPySCRQSIZECONWrite = &HCC                     ' Script Queue size setting(0~13) WRITE
Public Const IPySCRQSTATUSRead = &H4D                       ' Script Queue status READ 12bit = &H005
...
Public Const IPyCAPCON1Read = &H50                          ' Caption operation setting-1 READ 32bit = &H00000000
Public Const IPyCAPCON1Write = &HD0                         ' Caption operation setting-1 WRITE
Public Const IPyCAPCON2Read = &H51                          ' Caption operation setting-2 READ 32bit = &H00000000
Public Const IPyCAPCON2Write = &HD1                         ' Caption operation setting-2 WRITE
Public Const IPyCAPCON3Read = &H52                          ' Caption operation setting-3 READ 32bit = &H00000000
Public Const IPyCAPCON3Write = &HD2                         ' Caption operation setting-3 WRITE
Public Const IPyCAPCONQRead = &H53                          ' Caption operation setting-Queue READ 32bit = &H00000000
Public Const IPyCAPCONQWrite = &HD3                         ' Caption operation setting-Queue WRITE
Public Const IPyCAPDATA1Read = &H54                         ' Caption operation data1 READ 32bit = &H00000000
Public Const IPyNoOperation_D4 = &HD4                       ' No operation
Public Const IPyCAPDATA2Read = &H55                         ' Caption operation data2 READ 32bit = &H00000000
Public Const IPyNoOperation_D5 = &HD5                       ' No operation
Public Const IPyCAPDATA3Read = &H56                         ' Caption operation data3 READ 32bit = &H00000000
Public Const IPyNoOperation_D6 = &HD6                       ' No operation
Public Const IPyCAPDATAQRead = &H57                         ' Caption operation data queue READ 32bit = &H00000000
Public Const IPyNoOperation_D7 = &HD7                       ' No operation
Public Const IPyNoOperation_58 = &H58                       ' No operation
Public Const IPyCAPQCLR = &HD8                              ' Caption Queue clear
Public Const IPyCAPCQSIZERead = &H59                        ' Caption operation setting queue index READ 4bit = &H00
Public Const IPyNoOperation_D9 = &HD9                       ' No operation
Public Const IPyCAPDQSIZERead = &H5A                        ' Caption operation data Queue Index READ 4bit = &H00
Public Const IPyNoOperation_DA = &HDA                       ' No operation
Public Const IPyCAPQFLAGRead = &H5B                         ' Caption Queue Full/Empty Flag READ 4bit = &H05
Public Const IPyNoOperation_DB = &HDB                       ' No operation
Public Const IPyCAPQSIZECONRead = &H5C                      ' Caption Queue size Setting(0~13) READ 16bit = &HD0D0
Public Const IPyCAPQSIZECONWrite = &HDC                     ' Caption Queue size Setting(0~13) WRITE
Public Const IPyCAPQSTATUSRead = &H5D                       ' Caption Queue status READ 12bit = &H005
...
Public Const IPxyEXFILTERDRead = &H6A                       ' EXTERNAL SENSOR FILTER WIDTH SET DATA READ 32bit = &H00050005
Public Const IPxyEXFILTERDWrite = &HEA                      ' EXTERNAL SENSOR FILTER WIDTH SET DATA WRITE
...
Public Const IPxyFUNCONRead = &H70                          ' Chip Function DATA READ
Public Const IPxyFUNCONWrite = &HF0                         ' Chip Function DATA WRITE
...
Public Const IPxyEXCNTCLRRead = &H77                        ' EXTERNAL COUNTER Setting DATA READ 9bit = &H00
Public Const IPxyEXCNTCLRWrite = &HF7                       ' EXTERNAL COUNTER Setting DATA WRITE
...
Public Const EVENT_QICNT1LE = &H8                           ' Counter1 ¡Â Comparater1 state.
Public Const EVENT_QICNT1GE = &H9                           ' Counter1 ¡Ã Comparater1 state.
...
Public Const EVENT_QICNT2LE = &H10                          ' Counter2 ¡Â Comparater2 state.
Public Const EVENT_QICNT2GE = &H11                          ' Counter2 ¡Ã Comparater2 state.
...
Public Const EVENT_QICNT3LE = &H18                          ' Counter3 ¡Â Comparater3 state.
Public Const EVENT_QICNT3GE = &H19                          ' Counter3 ¡Ã Comparater3 state.
...
Public Const EVENT_QICNT4LE = &H20                          ' Counter4 ¡Â Comparater4 state.
Public Const EVENT_QICNT4GE = &H21                          ' Counter4 ¡Ã Comparater4 state.
...
Public Const EVENT_QICNT5LE = &H28                          ' Counter5 ¡Â Comparater5 state.
Public Const EVENT_QICNT5GE = &H29                          ' Counter5 ¡Ã Comparater5 state.
...
Public Const EVENT_QIDEVLE = &H30                           ' DEVIATION value ¡Â Comparater4 state.
Public Const EVENT_QIDEVGE = &H31                           ' DEVIATION value ¡Ã Comparater4 state.
