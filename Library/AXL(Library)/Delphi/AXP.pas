...
function AxpMacroGetNode (lMacroNo : LongInt; lNodeNo : LongInt; uFunction : DWord; dpArg : PDouble) : DWord; stdcall;
...
function AxpMacroStart (lMacroNo : LongInt; uCondition : DWord; bLockResource : LongBool; lRepeatCount : LongInt) : DWord; stdcall;
// Returns the driving condition of the specified macro.
// lMacroNo         : 0 ~ 7
function AxpMacroGetStartInfo (lMacroNo : LongInt; upCondition : PDWord; bpLockResource : PLongBool; lpRepeatCount : PLongInt) : DWord; stdcall;
...
//  [0] MACRO_QUICK_STOP
//  [1] MACRO_SLOW_STOP
function AxpMacroStop (lMacroNo : LongInt; uStopMode : DWord) : DWord; stdcall;
...
function AxpMacroReadFunctionStatus (lMacroNo : LongInt; uFunction : DWord; dpReturnData : PDouble) : DWord; stdcall;
...
const
    ...
    function AxpMacroBeginNode; external dll_name name 'AxpMacroBeginNode';
    function AxpMacroEndNode; external dll_name name 'AxpMacroEndNode';
    function AxpMacroWriteClear; external dll_name name 'AxpMacroWriteClear';
    function AxpMacroAddNode; external dll_name name 'AxpMacroAddNode';
    function AxpMacroGetNode; external dll_name name 'AxpMacroGetNode';
    function AxpMacroCheckNodeAll; external dll_name name 'AxpMacroCheckNodeAll';
    function AxpMacroStart; external dll_name name 'AxpMacroStart';
    function AxpMacroGetStartInfo ; external dll_name name 'AxpMacroGetStartInfo';
    function AxpMacroStop; external dll_name name 'AxpMacroStop';
    function AxpMacroReadRunStatus; external dll_name name 'AxpMacroReadRunStatus';
    function AxpMacroGetNodeNum; external dll_name name 'AxpMacroGetNodeNum';
    function AxpMacroReadFunctionStatus; external dll_name name 'AxpMacroReadFunctionStatus';    
end.
