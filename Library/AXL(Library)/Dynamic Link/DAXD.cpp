...
funcAxdInfoGetModuleEx                  *AxdInfoGetModuleEx;
...
funcAxdoSetNetworkErrorUserValue        *AxdoSetNetworkErrorUserValue; 
funcAxdSetContactNum                    *AxdSetContactNum;
funcAxdGetContactNum                    *AxdGetContactNum;

funcAxdoWriteOutportByBitOffset         *AxdoWriteOutportByBitOffset;
funcAxdiReadInportByBitOffset           *AxdiReadInportByBitOffset;
funcAxdoReadOutportByBitOffset          *AxdoReadOutportByBitOffset;
...
BOOL LoadAXD()
{
    ...
    if (g_hAXD)
    {
		...
		AxdInfoGetModuleEx              = (funcAxdInfoGetModuleEx *)GetProcAddress(g_hAXD, "AxdInfoGetModuleEx");
        ...
        AxdoSetNetworkErrorUserValue    = (funcAxdoSetNetworkErrorUserValue *)GetProcAddress(g_hAXD, "AxdoSetNetworkErrorUserValue"); //
        ...
        AxdoWriteOutportByBitOffset     = (funcAxdoWriteOutportByBitOffset *)GetProcAddress(g_hAXD, "AxdoWriteOutportByBitOffset"); //
        AxdiReadInportByBitOffset       = (funcAxdiReadInportByBitOffset *)GetProcAddress(g_hAXD, "AxdiReadInportByBitOffset");
        AxdoReadOutportByBitOffset      = (funcAxdoReadOutportByBitOffset *)GetProcAddress(g_hAXD, "AxdoReadOutportByBitOffset");
        return TRUE;
    }
    else
    {
