...
funcAxcInfoGetModuleEx                           *AxcInfoGetModuleEx;
...
funcAxcTriggerSetNotchEnable                     *AxcTriggerSetNotchEnable;
funcAxcTriggerGetNotchEnable                     *AxcTriggerGetNotchEnable;
...
BOOL LoadAXC()
{
    ...
    if (g_hAXC)
    {
        ...
        AxcInfoGetModuleEx                            = (funcAxcInfoGetModuleEx *)GetProcAddress(g_hAXC, "AxcInfoGetModuleEx");
        ...
        AxcTriggerSetNotchEnable                      = (funcAxcTriggerSetNotchEnable *)GetProcAddress(g_hAXC, "AxcTriggerSetNotchEnable");
        AxcTriggerGetNotchEnable                      = (funcAxcTriggerGetNotchEnable *)GetProcAddress(g_hAXC, "AxcTriggerGetNotchEnable");
