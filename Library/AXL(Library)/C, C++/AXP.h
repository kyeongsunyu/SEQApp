...
extern "C" {
    ...
    // ※ Note: The number of arrays must be 16
    //  [0] MACRO_FUNC_CALL
    //      dArg[0] Macro Number
    //  [1] MACRO_FUNC_JUMP
    ...
    // ※ Note: Be sure to validate nodes registered with this function so that you can run macros.
    // lMacroNo         : 0 ~ 7
    ...
    // ※ Note: Be sure to validate the nods registered with the AxpMacroCheckNodeAll function before you can run the macro.
    // lMacroNo         : 0 ~ 7
