...
[DllImport("AXL.dll")] public static extern uint AxmStatusGetServoAlarmString(int nAxisNo, uint uAlarmCode, int nAlarmStringSize, ref byte[] szAlarmString);
[DllImport("AXL.dll")] public static extern uint AxmStatusReadServoAlarmString(int lAxisNo, int lAlarmStringSize, ref char[] szAlarmString);
...
// For the profile arc continuous interpolation move, save it internal queue and start by using AxmContiStart API.
// nAxisNo = 2 axis array , dMidPos = middle point, X,Y array , dEndPos = ending point X,Y array, lArcCircle = arc(0), circle(1)
...
// For the profile arc continuous interpolation move, save it internal queue and start by using AxmContiStart API.
// nAxisNo = 2 axis array , dRadius = radius, dEndPos = ending point X,Y array , uShortDistance = small circle(0), large circle(1)
// uCWDir   DIR_CCW(0): Counterclockwise direction,   DIR_CW(1) Clockwise direction
...
// For the profile arc continuous interpolation move, save it internal queue and start by using AxmContiStart API.
// nAxisNo = 2 axis array , dCenterPos = center point X,Y array , dAngle = angle.
// uCWDir   DIR_CCW(0): Counterclockwise direction,   DIR_CW(1) Clockwise direction
...
[DllImport("AXL.dll")] public static extern uint AxmMotVibrationControlCoordEnable(int nCoordNo, uint dwEnable);

// Reads whether Vibration Control is enabled in the specified coordinate system.
[DllImport("AXL.dll")] public static extern uint AxmMotVibrationControlCoordIsEnable(int nCoordNo, ref uint pdwEnable);
...
[DllImport("AXL.dll")] public static extern uint AxmMotSetMultiTorqueLimit(int nAxisNo, int nSize, ref double dpPosition, ref double dpPlusTorqueLimit, ref double dpMinusTorqueLimit, int nTarget);
...
[DllImport("AXL.dll")] public static extern uint AxmCompensationTwoDimSet(int lTableNo, int lSourceAxis1, int lSourceAxis2, int lTargetAxis1, int lTargetAxis2, int lSize1, int lSize2, ref double dpMotorPosition1, ref double dpMotorPosition2, ref double dpLoadPosition1, ref double dpLoadPosition2);
[DllImport("AXL.dll")] public static extern uint AxmCompensationTwoDimGet(int lTableNo, ref int lpSourceAxis1, ref int lpSourceAxis2, ref int lpTargetAxis1, ref int lpTargetAxis2, ref int lpSize1, ref int lpSize2, ref double dpMotorPosition1, ref double dpMotorPosition2, ref double dpLoadPosition1, ref double dpLoadPosition2);
...
//DWORD    __stdcall AxmStatusReadServoAlarm(long nAxisNo, DWORD uReturnMode, DWORD *upAlarmCode);

//DWORD    __stdcall AxmStatusGetServoAlarmString(long nAxisNo, DWORD uAlarmCode, long lAlarmStringSize, char *szAlarmString);
...
[DllImport("AXL.dll")] public static extern uint AxmCircleCenterMoveWithAxes(int nCoord, int nArraySize, ref int npAxisNo, ref double dCenterPosition, ref double dEndPosition, double dMaxVelocity, double dMaxAccel, double dMaxDecel, uint uCWDir, bool b3DCircle);
    ...
    [DllImport("AXL.dll")] public static extern uint AxmCircleRadiusMoveWithAxes(int lCoord, int lArraySize, ref int lpAxisNo, double dRadius, ref double dEndPos, double dVel, double dAccel, double dDecel, uint uCWDir, uint uShortDistance);


    [DllImport("AXL.dll")] public static extern uint AxmCircleAngleMoveWithAxes(int lCoord, int lArraySize, ref int lpAxisNo, ref double dCenterPos, double dAngle, double dVel, double dAccel, double dDecel, uint uCWDir);

    [DllImport("AXL.dll")] public static extern uint AxmCirclePointMoveWithAxes(int lCoordNo, int lArraySize, ref int lpAxisNo, ref double dpMidPos, ref double dpEndPos, double dVel, double dAccel, double dDecel, int lArcCircle);
...
// For linear profile continuous interpolation drive, store it in internal queue and start using AxmContiStart function.
// The axes corresponding to the axis array of lpAxisNo are subjected to linear interpolation and the axes of the remaining coordinate axes perform the single axis driving according to the linear interpolation ratio.
[DllImport("AXL.dll")] public static extern uint AxmLineMoveWithAxesWithEvent(int nCoord, int nArraySize, ref int npAxisNo, ref double dpEndPos, double dVel, double dAccel, double dDecel, uint dwEventFlag);
...
// uCWDir          : DIR_CCW(0), DIR_CW(1)
// dw3DCircle      : 2-D circular interpolation and linear interpolation for more axes(0), 3-D circular interpolation and linear interpolation for more axes(1)
[DllImport("AXL.dll")] public static extern uint AxmCircleCenterMoveWithAxesWithEvent(int nCoord, int nArraySize, ref int npAxisNo, ref double dpCenterPosition, ref double dpEndPosition, double dMaxVelocity, double dMaxAccel, double dMaxDecel, uint uCWDir, uint dw3DCircle, uint dwEventFlag);


    [DllImport("AXL.dll")] public static extern uint AxmMovePVT(int lAxisNo, uint dwArraySize, ref double pdPos, ref double pdVel, ref uint pdwUsec);


    [DllImport("AXL.dll")] public static extern uint AxmSyncSetAxisMap(int lSyncNo, int lSize, ref int lpAxesNo);
