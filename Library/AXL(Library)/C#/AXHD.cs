...
namespace Shared
{
    ...
    {                          
        ...
        public enum IPCOMMAND
        {
            ...
            IPySCRDQSIZERead         = 0x4A,        // Script action data Queue index READ, 4bit, 0x000
        ...
        public static uint QI_OPERATION_COMMAND(int Command, int Axis)     // bit 7..0 : enum _QISCOMMAND ÂüÁ¶
        {
